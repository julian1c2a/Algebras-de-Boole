...
\item
  ...
  \item
    ...
    \item
      ...
      \end{enumerate}
    \item
      Definición:\[\mathit{atom}{(x)}\overset{\text{def}}{\Leftrightarrow}{\left\lbrack {x \in (1,0)_{B}} \right\rbrack \land \left\lbrack {\forall{y \in (1,0)_{B}}\left( {\left( {{x \cdot y} = x} \right) + \left( {{x \cdot y} = 0} \right)} \right)} \right\rbrack}\]
    \item
      \[\forall x,{y \in B}\mathit{atom}{{(x)} \land \mathit{atom}}{(y)}\Rightarrow{{x \cdot y} = 0}\].
    \item
      Definición:\[\mathit{hatom}{(x)}\overset{\text{def}}{\Leftrightarrow}{\left\lbrack {x \in \left( {B \smallsetminus {\{ 0,1\}}} \right)} \right\rbrack \land \left\lbrack {\forall{y \in \left( {B \smallsetminus {\{ 0,1\}}} \right)}\left( {\left( {{x + y} = x} \right) + \left( {{x + y} = 1} \right)} \right)} \right\rbrack}\]
    \item
    ...
    \item
      ...
      \item
        \[\forall X,{Y \in P}{X \neq Y}\Rightarrow{{X \supset {Y + Y}} \supset X}\]
      \item
        \[\forall X,{Y \in P}{X \neq Y}\Rightarrow{\left( {\left( {Y \supset X} \right) + \left( {Y \supset X} \right)} \right) \land \left( {\left( {{Y \cap X} = X} \right) + \left( {{Y \cap X} = Y} \right)} \right)}\]
      \item
        \[\forall X,{Y \in P}{X \neq Y}\Rightarrow{\left( {\left( {{Y \cap X} = X} \right) + \left( {{Y \cap X} = Y} \right)} \right) \land \left( {{X \neq {{\{ 0\}} \land Y}} \neq {\{ 0\}}} \right)}\]
      \item
