...
\begin{quote}\textbf{Definicion (Operador XNOR (No-O-exclusiva o Equivalencia)):}\label{xnor}
...
\begin{quote}\textbf{Definicion (Generalización a $n$ variables de NAND y NOR):}\label{gen_nand_nor}
...
\begin{quote}\textbf{Teorema (Idempotencia cruzada (Generación de NOT)):}\label{idemp_cruzada}
...
\begin{quote}\textbf{Teorema (Generación del Ínfimo y Supremo (AND y OR)):}\label{gen_inf_sup}
...
\begin{quote}\textbf{Teorema (Generación cruzada (Leyes de De Morgan para NAND/NOR)):}\label{gen_cruzada}
...
\begin{quote}\textbf{Teorema (Conmutatividad):}\label{conmut_deriv}
...
\begin{quote}\textbf{Teorema (Inexistencia de Elemento Neutro):}\label{no_neutro}
...
\begin{quote}\textbf{Teorema (Comportamiento con las constantes (Fijación y Absorción)):}\label{constantes_deriv}
...
\begin{quote}\textbf{Teorema (Ausencia de Asociatividad):}\label{no_asoc_deriv}
...
\begin{quote}\textbf{Definicion (NAND y NOR de $n$ entradas):}\label{def_n_entradas}
...
\begin{quote}\textbf{Teorema (NAND/NOR múltiple vs agrupación binaria):}\label{multiple_vs_binaria}
...
\begin{quote}\textbf{Teorema (Extensión del Principio de Dualidad (NAND y NOR)):}\label{dualidad_nand_nor}
...
\begin{quote}\textbf{Teorema (Conmutatividad):}\label{conmut_xor}
...
\begin{quote}\textbf{Teorema (Elementos Neutros e Inversores):}\label{neutro_xor}
...
\begin{quote}\textbf{Teorema (Elemento Inverso de sí mismo (Grupo Abeliano)):}\label{idemp_nula_xor}
...
\begin{quote}\textbf{Teorema (Propiedades de Negación):}\label{negacion_xor}
...
\begin{quote}\textbf{Teorema (Asociatividad):}\label{asoc_xor}
...
\begin{quote}\textbf{Teorema (Generalización n-aria (XOR y XNOR)):}\label{gen_xor}
...
\begin{quote}\textbf{Teorema (Distributividad (AND sobre XOR y OR sobre XNOR)):}\label{dist_xor}
...
\begin{quote}\textbf{Teorema (Extensión del Principio de Dualidad (XOR y XNOR)):}\label{dualidad_xor_xnor}
...
\begin{quote}\textbf{Teorema (Estructura de Grupo Conmutativo):}\label{grupo_xor}
...
\begin{quote}\textbf{Teorema (Estructura de Anillo Conmutativo (Anillo Booleano)):}\label{anillo_booleano}
