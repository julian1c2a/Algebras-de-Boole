...
\begin{circuitikz}
% ANSI
\draw (0,0) node[american and port] (myand_ansi) {}
(myand_ansi.in 1) node[anchor=east] {$a$}
(myand_ansi.in 2) node[anchor=east] {$b$}
(myand_ansi.out) node[anchor=west] {$a \cdot b$};
\node at (0, -1.5) {\small Símbolo ANSI};

% IEEE/IEC
\draw (5,0) node[european and port] (myand_ieee) {}
(myand_ieee.in 1) node[anchor=east] {$a$}
(myand_ieee.in 2) node[anchor=east] {$b$}
(myand_ieee.out) node[anchor=west] {$a \cdot b$};
\node at (5, -1.5) {\small Símbolo IEEE/IEC};
\end{circuitikz}
\end{center}
...
\begin{circuitikz}
% ANSI
\draw (0,0) node[american or port] (myor_ansi) {}
(myor_ansi.in 1) node[anchor=east] {$a$}
(myor_ansi.in 2) node[anchor=east] {$b$}
(myor_ansi.out) node[anchor=west] {$a + b$};
\node at (0, -1.5) {\small Símbolo ANSI};

% IEEE/IEC
\draw (5,0) node[european or port] (myor_ieee) {}
(myor_ieee.in 1) node[anchor=east] {$a$}
(myor_ieee.in 2) node[anchor=east] {$b$}
(myor_ieee.out) node[anchor=west] {$a + b$};
\node at (5, -1.5) {\small Símbolo IEEE/IEC};
\end{circuitikz}
\end{center}
...
\begin{circuitikz}
% ANSI
\draw (0,0) node[american xor port] (myxor_ansi) {}
(myxor_ansi.in 1) node[anchor=east] {$a$}
(myxor_ansi.in 2) node[anchor=east] {$b$}
(myxor_ansi.out) node[anchor=west] {$a \oplus b$};
\node at (0, -1.5) {\small Símbolo ANSI};

% IEEE/IEC
\draw (5,0) node[european xor port] (myxor_ieee) {}
(myxor_ieee.in 1) node[anchor=east] {$a$}
(myxor_ieee.in 2) node[anchor=east] {$b$}
(myxor_ieee.out) node[anchor=west] {$a \oplus b$};
\node at (5, -1.5) {\small Símbolo IEEE/IEC};
\end{circuitikz}
\end{center}
...
\begin{circuitikz}
% ANSI
\draw (0,0) node[american xnor port] (myxnor_ansi) {}
(myxnor_ansi.in 1) node[anchor=east] {$a$}
(myxnor_ansi.in 2) node[anchor=east] {$b$}
(myxnor_ansi.out) node[anchor=west] {$a \odot b$};
\node at (0, -1.5) {\small Símbolo ANSI};

% IEEE/IEC
\draw (5,0) node[european xnor port] (myxnor_ieee) {}
(myxnor_ieee.in 1) node[anchor=east] {$a$}
(myxnor_ieee.in 2) node[anchor=east] {$b$}
(myxnor_ieee.out) node[anchor=west] {$a \odot b$};
\node at (5, -1.5) {\small Símbolo IEEE/IEC};
\end{circuitikz}
\end{center}
