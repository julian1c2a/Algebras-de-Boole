...
\begin{quote}\textbf{Teorema (Unicidad de los elementos neutros - $Unic_e, Unic_u$):}\label{unicidad_neutros}
...
\begin{quote}\textbf{Teorema (Idempotencia - $Idemp_\vee, Idemp_\wedge$):}\label{idempotencia}
...
\begin{quote}\textbf{Teorema (Elementos absorbentes - $Abs_{\bot}, Abs_{\top}$):}\label{absorbentes}
...
\begin{quote}\textbf{Teorema (Condición de Álgebra Trivial):}\label{trivial_cond}
...
\begin{quote}\textbf{Teorema (Complemento Idéntico implica Álgebra Trivial):}\label{trivial_comp}
...
\begin{quote}\textbf{Teorema (Propiedades de absorción - $Abs_{\vee}, Abs_{\wedge}$):}\label{absorcion}
...
\begin{quote}\textbf{Teorema (Propiedades de orden de retículo - $Prop_{\vee,\wedge}$):}\label{prop_reticulo}
...
\begin{quote}\textbf{Teorema (Equivalencia de operaciones - $Equa_{\vee,\wedge}$):}\label{equa_operaciones}
...
\begin{quote}\textbf{Teorema (Teorema de Cancelación - $Equa_{canc}$):}\label{equa_canc}
...
\begin{quote}\textbf{Teorema (Unicidad del complemento - $Unic_{comp}$):}\label{unic_comp}
...
\begin{quote}\textbf{Teorema (Involución - $Comp_{inv}$):}\label{comp_inv}
...
\begin{quote}\textbf{Teorema (Leyes de De Morgan - $Mor_{\vee, \wedge}$):}\label{morgan}
...
\begin{quote}\textbf{Teorema (Asociatividad - $Asoc_\vee, Asoc_\wedge$):}\label{asociatividad}
...
\section{Teoremas de Simplificación}

Además de los teoremas deducidos directamente de los axiomas, existen tres teoremas de simplificación de enorme utilidad práctica, especialmente en la minimización de funciones booleanas.

\begin{quote}\textbf{Teorema (Teorema de Adyacencia (Expansión de Shannon) - $Ady_{\vee, \wedge}$):}\label{adyacencia}
Cualquier elemento $a$ puede ser expandido con respecto a otra variable $b$ y su complemento.
\begin{align*}
...
\end{align*}
La prueba para el producto es estrictamente dual:
\begin{align*}
...
\begin{quote}\textbf{Teorema (Teorema de Reducción (Absorción Fuerte) - $Red_{\vee, \wedge}$):}\label{reduccion}
La disyunción de una variable con la conjunción de su complemento y otra variable, se reduce a la disyunción de ambas variables.
\begin{align*}
...
\begin{proof}
Demostración para la disyunción:
\begin{align*}
...
\end{align*}
Demostración dual para la conjunción:
\begin{align*}
...
\begin{quote}\textbf{Teorema (Teorema del Consenso (Quine) - $Cons_{\vee, \wedge}$):}\label{consenso}
En una expresión con tres variables donde una variable aparece afirmada en un término, negada en otro, y el tercer término (el consenso) está formado por las variables restantes, este último término es redundante.
\begin{align*}
...
\begin{proof}
Demostración para la versión en $\vee:$
\begin{align*}
...
\end{align*}
La prueba dual sigue el mismo principio (sumar $\bot$ al consenso, expandirlo con $(a \wedge \neg a),$ y simplificar usando absorción).
\end{proof}
...
\begin{quote}\textbf{Definicion (Disyunción (Supremo) de $n$ variables):}\label{or_n_variables}
...
\begin{quote}\textbf{Definicion (Conjunción (Ínfimo) de $n$ variables):}\label{and_n_variables}
