...
\begin{quote}\textbf{Preaxioma ([H0.0.0] Estructura de Conjunto - EsConjunto($\mathbb{B}$)):}\label{esconj}
Se requiere que $\mathbb{B}$ sea un conjunto.
\end{quote}

\begin{quote}\textbf{Preaxioma ([H0.0.1, H0.0.2] Elementos Constantes - Constantes):}\label{constantes}
...
\begin{quote}\textbf{Preaxioma ([H0.1] Operación Binaria Interna $\vee$ - OpBinInt$_\vee$):}\label{opbinint_vee}
$\vee : \mathbb{B} \times \mathbb{B} \to \mathbb{B}$ es una operación binaria interna.
\end{quote}

\begin{quote}\textbf{Preaxioma ([H0.2] Operación Binaria Interna $\wedge$ - OpBinInt$_\wedge$):}\label{opbinint_wedge}
...
\begin{quote}\textbf{Preaxioma ([H.0.1.0] Existencia $\vee$ - Existencia$_\vee$):}\label{exist_vee}
...
\begin{quote}\textbf{Preaxioma ([H.0.2.0] Existencia $\wedge$ - Existencia$_\wedge$):}\label{exist_wedge}
Análogamente, $\forall \langle a,b \rangle \in \mathbb{B} \times \mathbb{B},$ $\exists d \in \mathbb{B}$ tal que $a \wedge b = d.$
\end{quote}

\begin{quote}\textbf{Preaxioma ([H.0.1.1] Unicidad $\vee$ - Unicidad$_\vee$):}\label{unic_vee}
Para un par solo existe una imagen. Esto es, si $a \vee b = c$ y $a \vee b = d,$ entonces $c = d.$
\end{quote}

\begin{quote}\textbf{Preaxioma ([H.0.2.1] Unicidad $\wedge$ - Unicidad$_\wedge$):}\label{unic_wedge}
...
\begin{quote}\textbf{Postulado ([H1.1] Elemento neutro $\vee$ - $ElemNeu_\vee$):}\label{neutro_vee}
...
\begin{quote}\textbf{Postulado ([H1.2] Elemento neutro $\wedge$ - $ElemNeu_\wedge$):}\label{neutro_wedge}
...
\begin{quote}\textbf{Postulado ([H2.1] Conmutatividad $\vee$ - $Comm_\vee$):}\label{conmut_vee}
...
\begin{quote}\textbf{Postulado ([H2.2] Conmutatividad $\wedge$ - $Comm_\wedge$):}\label{conmut_wedge}
...
\begin{quote}\textbf{Postulado ([H3.1] Distributividad $\vee$ sobre $\wedge$ - $Dist_\vee$):}\label{distrib_vee_wedge}
...
\begin{quote}\textbf{Postulado ([H3.2] Distributividad $\wedge$ sobre $\vee$ - $Dist_\wedge$):}\label{distrib_wedge_vee}
...
\begin{quote}\textbf{Postulado ([H4] Complementario - $Comp_\vee, Comp_\wedge$):}\label{comp}
