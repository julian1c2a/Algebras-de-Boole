...
\begin{definicion}{Anillo Booleano}{def_anillo_booleano_cap}
...
\begin{teorema}{Característica 2}{caracteristica_dos}
...
\begin{teorema}{Conmutatividad estricta}{conmutatividad_estricta}
...
\begin{teorema}{El único Cuerpo Booleano es $\mathbb{F}_2$}{cuerpo_booleano}
