...
\item
  ...
  \item
    ...
    (el\[\mathbf{lsb}\]) y al\[l_{\mathbf{\mathrm{n - 1}}}\]el dígito
    más significativo (el \[\mathbf{\mathrm{msb}}\]). Pri\-mero
  ...
  \item
    ...
    \item
      ...
      general\[{{\left\{ \mathbf{0} \right\} + \left\{ \mathbf{00} \right\}} + \left\{ \mathbf{10} \right\}} + \left( {{\mathbf{D}_{\mathbf{\mathrm{2}}} \cdot \left( {\mathbf{D}_{\mathbf{\mathrm{n}}} \smallsetminus \left\{ d_{0} \right\}} \right)} \cdot \left( \mathbf{D}_{\mathbf{\mathrm{n}}} \right)^{\ast}} \right)\],
      habida cuenta que
    ...
    \item
      ...
      \item
        ...
        \[\mathbf{1}\], a continuación no tendremos un dígito
        \[\mathbf{d}_{\mathbf{\mathrm{n - 1}}}\], sino cualquier otro, y
        una ristra finita cualquiera de dígitos sobre el alfabeto
        \[\mathbf{D}_{\mathbf{\mathrm{n}}}\]. Para cualquier palabra
        sobre el alfabeto dicho definimos el valor en Complemento a la
        base B con 1 y con 0.
    ...
    \item
      ...
      necesario una vez se conocen la longitudes de las partes entera y
      fraccionaria.
    \item
  ...
  \item
    ...
    tipo está estandarizado y tenemos un documento que lo detalla
...
\item
  ...
  \item
    ...
    $\text{\texttt{dígito BCD}}$, y es apropiado para tratamiento muy
  ...
  \item
    ...
    \item
      ...
      \item
        ...
        seguirá siendo un $n - \text{\textit{código}}$.
      \item
        ...
        Con un error de \[0,50\]el sistema es plenamente aleatorio. No
    ...
    \item
      ...
      \[\mathtt{\mathrm{n}} - \text{\textit{código}}\], la distancia Hamming
    ...
    \item
      ...
      se cumple la desigualdad triangular, para tres palabras
      cuales\-quiera
      ...
      dónde podemos poner como puntos los \[\text{\textit{minitérminos}}\]o
      bien los \[\text{\textit{maxitérminos}}\], en general, a estos, vistos
    ...
    \item
      ...
      \[\mathtt{\mathrm{n}} - \text{\textit{código}}\]hay algunos trucos que
      nos ayudarán:
      ...
      \item
        ...
        resultado, tipo cota de la dis\-tancia mínima en función del
        cardinal del código, se puede extender para distancia mínima 2,
        ... Por
      ...
      \item
        ...
        \[\mathtt{\mathrm{n}} - \text{\textit{código}}\] original, en
