...
\title{Manual de Ingeniería Digital: Álgebras de Boole (Simbología IEEE)}
\author{}
\date{\today}
...
\begin{itemize}
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european or port] (or) at (0,0) {};
      \node[left] at (or.in 1) {$a$};
...
\begin{itemize}
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european or port] (or1) at (0,0) {};
      ...
      \node[european or port] (or2) at (5,0) {};
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european and port] (and1) at (0,0) {};
      ...
      \node[european and port] (and2) at (5,0) {};
...
\begin{itemize}
    ...
    \begin{circuitikz}[scale=0.8, transform shape]
      % Left side
      \node[european or port] (or1) at (0,-0.5) {};
      \node[left] at (or1.in 1) {$b$};
      \node[left] at (or1.in 2) {$c$};
      
      \node[european and port] (and1) at (2.5,0) {};
      \node[left] at (and1.in 1) {$a$};
      ...
      % Right side
      \node[european and port] (and2) at (7,0.5) {};
      \node[left] at (and2.in 1) {$a$};
      \node[left] at (and2.in 2) {$b$};
      
      \node[european and port] (and3) at (7,-1) {};
      \node[left] at (and3.in 1) {$a$};
      \node[left] at (and3.in 2) {$c$};
      
      \node[european or port] (or2) at (9.5,-0.25) {};
    ...
    \begin{circuitikz}[scale=0.8, transform shape]
      % Left side
      \node[european and port] (and1) at (0,-0.5) {};
      \node[left] at (and1.in 1) {$b$};
      \node[left] at (and1.in 2) {$c$};
      
      \node[european or port] (or1) at (2.5,0) {};
      \node[left] at (or1.in 1) {$a$};
      ...
      % Right side
      \node[european or port] (or2) at (7,0.5) {};
      \node[left] at (or2.in 1) {$a$};
      \node[left] at (or2.in 2) {$b$};
      
      \node[european or port] (or3) at (7,-1) {};
      \node[left] at (or3.in 1) {$a$};
      \node[left] at (or3.in 2) {$c$};
      
      \node[european and port] (and2) at (9.5,-0.25) {};
...
\begin{itemize}
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european not port, scale=0.5] (not) at (0,-0.5) {};
      \node[left] at (not.in) {$a$};
      
      \node[european or port] (or) at (2.5,0) {};
      \node[left] at (or.in 1) {$a$};
    ...
    \begin{circuitikz}[scale=0.8, transform shape]
      ...
      \node[european and port] (and) at (2.5,0) {};
      \node[left] at (and.in 1) {$a$};
...
\begin{itemize}
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european and port] (and) at (0,-0.5) {};
      \node[left] at (and.in 1) {$a$};
      \node[left] at (and.in 2) {$b$};
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european or port] (or) at (0,-0.5) {};
      \node[left] at (or.in 1) {$a$};
      \node[left] at (or.in 2) {$b$};
...
\begin{itemize}
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european nor port] (nor) at (0,0) {};
      ...
      \node[european and port] (and) at (7.5,0) {};
      \node[european not port, scale=0.5] (not1) at (4.5,0.7) {};
      \node[european not port, scale=0.5] (not2) at (4.5,-0.7) {};
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european nand port] (nand) at (0,0) {};
      ...
      \node[european or port] (or) at (7.5,0) {};
      \node[european not port, scale=0.5] (not1) at (4.5,0.7) {};
      \node[european not port, scale=0.5] (not2) at (4.5,-0.7) {};
      \node[left] at (not1.in) {$a$};
      \node[left] at (not2.in) {$b$};
...
\begin{center}
\begin{circuitikz}[scale=0.8, transform shape]
  \node[european not port, scale=0.5] (not1) at (0,0) {};
  \node[european not port, scale=0.5] (not2) at (2,0) {};
  \node[left] at (not1.in) {$a$};
...
\begin{itemize}
    ...
    \begin{circuitikz}[scale=0.8, transform shape]
      ...
      \node[european or port] (or2) at (2.5,0) {};
      \node[left] at (or2.in 1) {$a$};
      \draw (or1.out) -| (or2.in 2);
      
      \node at (4.5,0) {\Large $=$};
      
      \node[european or port] (or3) at (6.5,0.5) {};
      \node[left] at (or3.in 1) {$a$};
      \node[left] at (or3.in 2) {$b$};
      
      \node[european or port] (or4) at (9,0) {};
    ...
    \begin{circuitikz}[scale=0.8, transform shape]
      ...
      \node[european and port] (and2) at (2.5,0) {};
      \node[left] at (and2.in 1) {$a$};
      \draw (and1.out) -| (and2.in 2);
      
      \node at (4.5,0) {\Large $=$};
      
      \node[european and port] (and3) at (6.5,0.5) {};
      \node[left] at (and3.in 1) {$a$};
      \node[left] at (and3.in 2) {$b$};
      
      \node[european and port] (and4) at (9,0) {};
...
\begin{circuitikz}[scale=0.8, transform shape]
  ...
  \node[european and port] (and) at (6,0) {};
  \node[left] at (and.in 1) {$a$};
  \node[left] at (and.in 2) {$b$};
...
\begin{center}
\begin{circuitikz}[scale=0.8, transform shape]
  \node[european or port] (or) at (0,1) {};
  \node[european and port] (and) at (0,-1) {};
  \node[left] at (or.in 1) {$a$};
  \node[left] at (or.in 2) {$b$};
  \node[left] at (and.in 1) {$a$};
  \node[left] at (and.in 2) {$b$};
...
\begin{itemize}
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european nand port] (nand1) at (0,0) {};
      \node[left] at (nand1.in 1) {$a$};
      \node[left] at (nand1.in 2) {$b$};
      
      \node at (2.5,0) {\Large $=$};
      
      \node[european nand port] (nand2) at (5,0) {};
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european nor port] (nor1) at (0,0) {};
      \node[left] at (nor1.in 1) {$a$};
      \node[left] at (nor1.in 2) {$b$};
      
      \node at (2.5,0) {\Large $=$};
      
      \node[european nor port] (nor2) at (5,0) {};
...
\begin{center}
\begin{circuitikz}[scale=0.8, transform shape]
  \node[european nand port, number inputs=3] (nand3) at (0,0) {};
  ...
  \node[european nand port] (nand2a) at (5,0.5) {};
  \node[left] at (nand2a.in 1) {$a$};
  \node[left] at (nand2a.in 2) {$b$};
  
  \node[european nand port] (nand2b) at (7.5,-0.25) {};
...
\begin{itemize}
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european xor port] (xor) at (0,0) {};
      ...
      \node[european and port] (and1) at (6,0.8) {};
      \node[european not port, scale=0.5] (not1) at (4,1.5) {};
      \node[left] at (not1.in) {$a$};
      \draw (not1.out) |- (and1.in 1);
      \draw (4,0.1) |- (and1.in 2);
      \node[left] at (4,0.1) {$b$};
      
      \node[european and port] (and2) at (6,-0.8) {};
      \node[european not port, scale=0.5] (not2) at (4,-1.5) {};
      \node[left] at (not2.in) {$b$};
      \draw (not2.out) |- (and2.in 2);
      \draw (4,-0.1) |- (and2.in 1);
      \node[left] at (4,-0.1) {$a$};
      
      \node[european or port] (or) at (8.5,0) {};
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european xnor port] (xnor) at (0,0) {};
      ...
      \node[european and port] (and1) at (6,0.8) {};
      \node[european not port, scale=0.5] (not1) at (4,1.5) {};
      \node[european not port, scale=0.5] (not2) at (4,0.1) {};
      \node[left] at (not1.in) {$a$};
      \node[left] at (not2.in) {$b$};
      \draw (not1.out) |- (and1.in 1);
...
\begin{itemize}
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european xor port] (xor1) at (0,0) {};
      \node[left] at (xor1.in 1) {$a$};
      \node[left] at (xor1.in 2) {$b$};
      
      \node at (2.5,0) {\Large $=$};
      
      \node[european xor port] (xor2) at (5,0) {};
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european xor port] (xor1) at (0,-0.5) {};
      \node[left] at (xor1.in 1) {$b$};
      \node[left] at (xor1.in 2) {$c$};
      
      \node[european xor port] (xor2) at (2.5,0) {};
      \node[left] at (xor2.in 1) {$a$};
      \draw (xor1.out) -| (xor2.in 2);
      
      \node at (4.5,0) {\Large $=$};
      
      \node[european xor port] (xor3) at (6.5,0.5) {};
      \node[left] at (xor3.in 1) {$a$};
      \node[left] at (xor3.in 2) {$b$};
      
      \node[european xor port] (xor4) at (9,0) {};
...
\begin{itemize}
    ...
    \begin{circuitikz}[scale=0.8, transform shape]
      ...
      \node[european not port, scale=0.5] (not) at (5,0) {};
      \node[left] at (not.in) {$a$};
      \node[right] at (not.out) {$\overline{a}$};
    \end{circuitikz}
    \end{center}
...
\begin{itemize}
    ...
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european nand port] (nand1) at (0,0) {};
      \node[european nand port] (nand2) at (3,0) {};
      \node[left] at (nand1.in 1) {$a$};
      \node[left] at (nand1.in 2) {$b$};
      ...
      \node[european and port] (and) at (8,0) {};
      \node[left] at (and.in 1) {$a$};
      \node[left] at (and.in 2) {$b$};
      \node[right] at (and.out) {$a \cdot b$};
    \end{circuitikz}
    ...
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european nor port] (nor1) at (0,0) {};
      \node[european nor port] (nor2) at (3,0) {};
      \node[left] at (nor1.in 1) {$a$};
      \node[left] at (nor1.in 2) {$b$};
      \draw (nor1.out) -- (1.5,0);
      ...
      \node[european or port] (or) at (8,0) {};
      \node[left] at (or.in 1) {$a$};
      \node[left] at (or.in 2) {$b$};
      \node[right] at (or.out) {$a + b$};
    \end{circuitikz}
...
\begin{itemize}
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european nand port] (nand_a) at (0,1) {};
      \node[european nand port] (nand_b) at (0,-1) {};
      \node[european nand port] (nand_out) at (3,0) {};
    ...
    \begin{center}
    \begin{circuitikz}[scale=0.8, transform shape]
      \node[european nor port] (nor_a) at (0,1) {};
      \node[european nor port] (nor_b) at (0,-1) {};
      \node[european nor port] (nor_out) at (3,0) {};
...
\begin{itemize}
    ...
    \begin{circuitikz}[scale=0.8, transform shape]
      ...
      \node[european nor port] (nor) at (6,0) {};
      \node[left] at (nor.in 1) {$a$};
...
\begin{itemize}
    ...
    \begin{circuitikz}[scale=0.8, transform shape]
      ...
      \node[european xnor port] (xnor) at (6,0) {};
      \node[left] at (xnor.in 1) {$a$};
...
\begin{circuitikz}[scale=0.8, transform shape]
  \node[european xor port] (xor1) at (0,0) {};
  \node[european not port, scale=0.5] (not1) at (-1.5, 0.28) {};
  \node[left] at (not1.in) {$a$};
  ...
  \node[european xor port] (xor2) at (4,0) {};
  \node[left] at (2.5, 0.28) {$a$};
  \node[european not port, scale=0.5] (not2) at (2.5, -0.28) {};
  \node[left] at (not2.in) {$b$};
  ...
  \node[european xnor port] (xnor) at (8,0) {};
  \node[left] at (xnor.in 1) {$a$};
  \node[left] at (xnor.in 2) {$b$};
\end{circuitikz}
\end{center}
...
\begin{center}
\begin{circuitikz}[scale=0.8, transform shape]
  \node[european and port, number inputs=4] (and4) at (0,0) {};
