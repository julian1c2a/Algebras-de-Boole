...
\begin{teorema}{Teorema de Adyacencia (Expansión de Shannon) - $Ady_{\vee, \wedge}$}{adyacencia}
...
\begin{teorema}{Teorema de Reducción (Absorción Fuerte) - $Red_{\vee, \wedge}$}{reduccion}
...
\begin{teorema}{Teorema del Consenso (Quine) - $Cons_{\vee, \wedge}$}{consenso}
